...
def insert_rule(bfrt):
    ...
    p4 = bfrt.c2_optsfc.SwitchIngress
...
# SFC1 : FW-NAT-L3-LB
    ...
    p4.ecmp_group.add_with_set_ecmp_select(dstaddr=ip_address("10.10.0.2"), dstaddr_p_length=24, metadata_spi=1, metadata_si=252, 
...
# SFC2 : LB-FW'
    ...
    p4.fw2.add_with_forward(srcaddr=1, lkp_ipv4_sa=ip_address("10.10.0.1"),
...
# SFC3 : NAT-L2-LB-L3'
    ...
    p4.ecmp_nhop.add_with_set_nhop(ecmp_select=0xEE72, ecmp_select_mask=0x0000, metadata_spi=3, metadata_si=254,
                nhop_dmac=2, nhop_ipv4=ip_address("10.10.0.2"), port=163)
    p4.send_frame.add_with_rewrite_mac(ucast_egress_port=163, metadata_spi=3, metadata_si=254,
                smac=1)

    p4.l32.add_with_send(lkp_ipv4_da=ip_address("10.10.0.2"), metadata_spi=3, metadata_si=253, port=163)