...
# SFC3 : NAT-L2-LB'-loopback-L3-FW
    ...
    # p4.send_frame2.add_with_rewrite_mac(ucast_egress_port=176, metadata_spi=3, metadata_si=254,
    #             smac=1)

    p4.l32.add_with_send(lkp_ipv4_da=ip_address("10.10.0.2"), metadata_spi=3, metadata_si=252, port=176)

    #loopback

    p4.fw.add_with_forward(srcaddr=1, lkp_ipv4_sa=ip_address("10.10.0.1"),
                metadata_spi=3, metadata_si=251, port=163)

    p4.sff.add_with_sff_forward_no_tstamp(metadata_spi=3, metadata_si=250)

# SFC4 : LB-NAT
    p4.ecmp_group.add_with_set_ecmp_select(dstaddr=ip_address("10.10.0.2"), 
                dstaddr_p_length=24, metadata_spi=4, metadata_si=255, 
                ecmp_base=1, ecmp_count=1)
